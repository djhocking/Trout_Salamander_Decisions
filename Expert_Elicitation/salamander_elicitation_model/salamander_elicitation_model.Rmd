...
p6<-ggplot(subset(qall.new,qall.new$question==6), aes(interaction(riparian,upland),1/(1+exp(-pred)),group=interaction(upland,species),color=factor(species))) + geom_point()+ geom_smooth()+ ylim(0,1) + ylab("prob occupancy")+ xlab("percentriparian.percentupland")
...
#rownames(betas.coef)<-c("int","drainage","temp","temp2","riparian","upland","trout","riparian.upland.int")
