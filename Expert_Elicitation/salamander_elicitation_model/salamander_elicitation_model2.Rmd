...
plot(qall.dfus$mean_reaches,col=qall.dfus$expert_ID)
plot(density(qall.gpor$mean_reaches))
plot(qall.gpor$mean_reaches,col=qall.gpor$expert_ID)
plot(density(qall.ebis$mean_reaches))
plot(qall.ebis$mean_reaches,col=qall.ebis$expert_ID)
...
p8.ebis<-ggplot(subset(qall.data,species %in% c("ebis") & question %in% c("8") & mean_reaches>=0),aes(sal_other,mean_reaches,shape=factor(expert_ID))) + geom_point(aes(y=mean_reaches),position=pd) + geom_errorbar(aes(ymin=lower_reaches, ymax=upper_reaches), width=.1, position=pd) + ylim(0, 100) + theme(legend.position="none") +  ggtitle("ebis")
grid.arrange(p8.dfus,p8.gpor,p8.ebis,ncol=3)
```
```{r calculate betas (glmer), echo=FALSE,results='hide'}

ggplot(qall.data,aes(x=question,y=mean_reaches,group=interaction(expert_ID,question),fill=factor(expert_ID))) + geom_boxplot()

# subset data for each species
qall.dfus<-subset(qall.data,qall.data$species=="dfus" & qall.data$expert_ID>=10 & qall.data$mean_reaches>=0)
qall.gpor<-subset(qall.data,qall.data$species=="gpor" & qall.data$expert_ID>=10 & qall.data$mean_reaches>=0)
qall.ebis<-subset(qall.data,qall.data$species=="ebis" & qall.data$expert_ID>=10 & qall.data$mean_reaches>=0)
...
# q3 - stream size
p10.dfus<-ggplot(subset(qall.new,qall.new$question==3 & species=="dfus"),aes(drainage_area_sqkm,pred,shape=factor(expert_ID))) + geom_point() + geom_line() + ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("catchment drainage area, km2") +ggtitle("dfus")
p10.gpor<-ggplot(subset(qall.new,qall.new$question==3 & species=="gpor"),aes(drainage_area_sqkm,pred,shape=factor(expert_ID))) + geom_point() + geom_line() + ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("catchment drainage area, km2")+ggtitle("gpor")
p10.ebis<-ggplot(subset(qall.new,qall.new$question==3 & species=="ebis"),aes(drainage_area_sqkm,pred,shape=factor(expert_ID))) + geom_point() + geom_line() + ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("catchment drainage area, km2")+ggtitle("ebis")
grid.arrange(p10.dfus,p10.gpor,p10.ebis)



# q4 - stream temp
p11<-ggplot(subset(qall.new,qall.new$question==4),aes(summer_temp_C,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line()+ ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("mean summer temp, C")+ggtitle("all")
p11

p11.dfus<-ggplot(subset(qall.new,qall.new$question==4&species=="dfus"),aes(summer_temp_C,pred,shape=factor(expert_ID))) + geom_point()+ geom_line()+ ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("mean summer temp, C")+ggtitle("dfus")
p11.gpor<-ggplot(subset(qall.new,qall.new$question==4&species=="gpor"),aes(summer_temp_C,pred,shape=factor(expert_ID))) + geom_point()+ geom_line()+ ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("mean summer temp, C")+ggtitle("gpor")
p11.ebis<-ggplot(subset(qall.new,qall.new$question==4&species=="ebis"),aes(summer_temp_C,pred,shape=factor(expert_ID))) + geom_point()+ geom_line()+ ylim(0,1) + ylab("predicted p(occupancy)")+ xlab("mean summer temp, C")+ggtitle("ebis")
grid.arrange(p11,p11.dfus,p11.gpor,p11.ebis,ncol=2)

# q5 - streamflow
p13.dry.small<-ggplot(subset(qall.new,qall.new$question==5 & flow_type==10 & stream_width_m==2),aes(flow_year_freq,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("frequency of dry years") + ggtitle("small stream, dry")
p13.wet.small<-ggplot(subset(qall.new,qall.new$question==5 & flow_type==190 & stream_width_m==2),aes(flow_year_freq,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("frequency of wet years") + ggtitle("small stream, wet")
p13.dry.medium<-ggplot(subset(qall.new,qall.new$question==5 & flow_type==10 & stream_width_m==2),aes(flow_year_freq,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("frequency of dry years") + ggtitle("medium stream, dry")
p13.wet.medium<-ggplot(subset(qall.new,qall.new$question==5 & flow_type==190 & stream_width_m==2),aes(flow_year_freq,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("frequency of wet years") + ggtitle("medium stream, wet")
grid.arrange(p13.dry.small,p13.wet.small,p13.dry.medium,p13.wet.medium)

# q6 - forest cover
p12.100<-ggplot(subset(qall.new,qall.new$question==6 & upland_forest==100),aes(s.ripa,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("percentriparian") + ggtitle("100% upland forest")
p12.75<-ggplot(subset(qall.new,qall.new$question==6 & upland_forest==75),aes(s.ripa,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("percentriparian") + ggtitle("75% upland forest")
p12.50<-ggplot(subset(qall.new,qall.new$question==6 & upland_forest==50),aes(s.ripa,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("percentriparian") + ggtitle("50% upland forest")
p12.25<-ggplot(subset(qall.new,qall.new$question==6 & upland_forest==25),aes(s.ripa,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("percentriparian") + ggtitle("25% upland forest")
p12.0<-ggplot(subset(qall.new,qall.new$question==6 & upland_forest==0),aes(s.ripa,pred,shape=factor(expert_ID),color=factor(species))) + geom_point()+ geom_line() + ylim(0,1) + ylab("predicted prob occupancy")+ xlab("percentriparian") + ggtitle("0% upland forest")
grid.arrange(p12.100,p12.75,p12.50,p12.25,p12.0)

# q7 - brook trout
pd <- position_dodge(.5)
p14<-ggplot(subset(qall.new,qall.new$question==7),aes(expert_ID,pred,shape=factor(expert_ID))) + geom_point(aes(y=mean_reaches)) + geom_errorbar(aes(ymin=lower_reaches, ymax=upper_reaches), width=.1, position=pd) + + ylim(0, 100)  + ggtitle("trout presence")
p14
```
...
p20<-ggplot(all.betas,aes(y=betas.mean,x=betas.name,shape=factor(betas.sp))) + geom_point(aes(shape=betas.sp),position=dodge,size=2,stat="identity") + geom_errorbar(aes(y=betas.mean,ymin=betas.mean-betas.sd,ymax=betas.mean+betas.sd),size=.5,position=dodge,width=.25) + coord_flip()    
p20
```
