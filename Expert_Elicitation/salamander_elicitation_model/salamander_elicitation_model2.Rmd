...
```
```{r calculate betas and plot predicted values, echo=FALSE,results='hide'}
...
```
```{r predict occ , echo=FALSE, results='hide'}
...
p21.dfus<-ggplot(cov.df,aes(ufor,dfus_pr_occ)) + geom_point() 
p21.ebis<-ggplot(cov.df,aes(ufor,ebis_pr_occ)) + geom_point() 
p21.gpor<-ggplot(cov.df,aes(ufor,gpor_pr_occ)) + geom_point() 
grid.arrange(p21.dfus,p21.ebis,p21.gpor)

p22.dfus<-ggplot(cov.df,aes(rfor,dfus_pr_occ)) + geom_point() 
p22.ebis<-ggplot(cov.df,aes(rfor,ebis_pr_occ)) + geom_point() 
p22.gpor<-ggplot(cov.df,aes(rfor,gpor_pr_occ)) + geom_point() 
grid.arrange(p22.dfus,p22.ebis,p22.gpor)

p23.dfus<-ggplot(cov.df,aes(area,dfus_pr_occ)) + geom_point() 
p23.ebis<-ggplot(cov.df,aes(area,ebis_pr_occ)) + geom_point() 
p23.gpor<-ggplot(cov.df,aes(area,gpor_pr_occ)) + geom_point() 
